...
func (r unstructuredScalableResource) Labels() map[string]string {
	...
	if val, found := annotations["capacity.cluster-autoscaler.kubernetes.io/labels"]; found {
...
func (r unstructuredScalableResource) Taints() []apiv1.Taint {
	...
	if val, found := annotations["capacity.cluster-autoscaler.kubernetes.io/taints"]; found {
